package com.example.onlinepdfreader;
...
import com.example.onlinepdfreader.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_PDF_PICK && resultCode == RESULT_OK) {
            if (data != null) {
